...
const MyToyElements = ({ mytoy }) => {
  const { tname, sname, url, category, price, quantity } = mytoy;
      ...
      <div className="border w-full mx-auto border-slate-400">
        <div className='grid grid-cols-9 justify-start items-center p-5'>
          ...
          <p className='flex gap-2 justify-start'>
            ...
            <div><button className='p-1 rounded text-2xl bg-red-500 text-white'><RiDeleteBinLine /></button></div>
          </p>
        </div>
      </div>
    </div>
